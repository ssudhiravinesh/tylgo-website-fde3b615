-- Single-Session Login Database Migration
...
-- 8. Enable realtime for session invalidation notifications
...
-- 10. Create trigger for automatic cleanup on new session creation
