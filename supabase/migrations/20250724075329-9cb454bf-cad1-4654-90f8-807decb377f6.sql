-- ==========================================
-- CLEAN BUILD: SINGLE SESSION MANAGEMENT
-- ==========================================

-- STEP 1: Clean slate - drop everything related to sessions
...
DROP FUNCTION IF EXISTS create_user_session_v2(UUID, TEXT, TIMESTAMPTZ);
DROP FUNCTION IF EXISTS validate_user_session_v2(UUID, TEXT);
DROP FUNCTION IF EXISTS invalidate_user_session_v2(UUID, TEXT);
