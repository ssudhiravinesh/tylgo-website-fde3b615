...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "btn-primary text-primary-foreground shadow-lg hover:shadow-xl",
        destructive: "bg-destructive text-destructive-foreground shadow-lg hover:shadow-xl hover:bg-destructive/90",
        outline: "neumorphic-button text-foreground hover:text-primary border border-input bg-background shadow-neumorphic hover:shadow-neumorphic",
        secondary: "btn-secondary text-secondary-foreground shadow-lg hover:shadow-xl",
        ghost: "hover:bg-accent hover:text-accent-foreground rounded-lg transition-colors",
        link: "text-primary underline-offset-4 hover:underline",
        accent: "btn-accent text-accent-foreground shadow-lg hover:shadow-xl",
        glass: "glassmorphic text-foreground hover:bg-white/20 border border-white/20",
        neumorphic: "neumorphic-button text-foreground hover:shadow-neumorphic",
      },
      size: {
